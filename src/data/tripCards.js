const tripCardDetails = {
  ...
  badlands: [
    {
      id: 2,
      title: "Day 1: Cedar Pass Campground",
      dates: "June 3, 2021",
      distance: "< 1 mile",
      elevation: "68 ft gain",
    ...
    {
      id: 3,
      title: "Day 2: Sage Creek Campground",
      dates: "June 4, 2021",
      distance: "11.39 miles",
      elevation: "206 ft gain",
      duration: "1 day / 1 night",
      summary:
        "After a good night's rest, and getting my bearings, the second day was all about getting out on the trails. I also needed to make my way over to Sage Creek Campground and figuring out where I would be sleeping that night. I had done a little bit of scouting the night before, but trail heads were easy to find, fairly large, and were not far from Cedar Pass where I slept the night before.",
      highlights: [
        "Amazing Sunsets",
        "Prairie Dog Village",
        "Panoramic Views",
